...
public class reservation {
	...
	public static void main(String args[]) {
		System.out.println("WELCOME TO INDIAN RAILWATS");
		System.out.println("BE CAREFUL IN COVID");
	...
	private static void printBoardingPass(int seatnumber) {
		...
		System.out.println("---KEEP SOCIAL DISTANCING--");
                System.out.println("<<CARRY SANITIZER WITH YOU>>");
                System.out.println("***CARRY YOUR MASK AND WEAR PROPERLY***");
